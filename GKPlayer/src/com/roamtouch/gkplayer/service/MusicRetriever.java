...
public class MusicRetriever {
    ...
    List<Song> mItems = new ArrayList<Song>();
    ...
    public void prepare() {
        ...
        //Cursor cur = mContentResolver.query(uri, null, android.provider.MediaStore.Audio.Artists.ARTIST+"=?", new String[]{"U2"}, null);
        ...
        int albumColumn = cur.getColumnIndex(android.provider.MediaStore.Audio.Media.ALBUM);
        int coverColumn = cur.getColumnIndex(android.provider.MediaStore.Audio.Media.ALBUM_ID);
        int songOrdercolumn = cur.getColumnIndex(android.provider.MediaStore.Audio.Media.TRACK);
        ...
        do {
            ...
            mItems.add(new Song(cur.getLong(idColumn), cur.getString(titleColumn), cur.getString(artistColumn), cur.getInt(coverColumn), cur.getString(albumColumn), cur.getString(songOrdercolumn)));
