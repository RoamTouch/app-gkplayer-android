...
import com.roamtouch.gesturekit.gkplayer.GKPlayer;
import com.roamtouch.gesturekit.gkplayer.R;
import com.roamtouch.gesturekit.gkplayer.graphics.Utils;
...
PrepareMusicRetrieverTask.MusicRetrieverPreparedListener, MusicFocusable{
	private final static String TAG = "GKPlayerPlayer";
	...
	void updateNotification(String text) {
		...
		mNotification.setLatestEventInfo(mContext, "GKPlayer", text, pi);
